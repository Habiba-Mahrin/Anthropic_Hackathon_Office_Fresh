...
- Neck & back pain  
- Mental fatigue  
- Poor posture (office syndrome)

The mission is simple: create a healthier and more productive work-life routine.
...
- Prevents neck strain, fatigue, and overall burnout  
...
- Upload stretch progress photos  
- Auto-generated visual wellness gallery  
- **Real-time pose detection** using **Gemini Vision**  
...
- Movement scoring  
- Real-time guidance  
- Photo analysis for long-term improvements  
...
- Feedback slider  
- Daily / Weekly / Monthly wellness stats  
